  ...
  return (
    <>
      <Layout
        ...
        imgbg={"/assets/images/page/about-us.jpg"}
      >
        <div>
                ...
                <div className="col-md-6">
                  <div className="image-about-h4-wrap relative">
                    <div className="image-about-item relative about-wrap-left">
                      <img
                        src="/assets/images/about-us/sl-1.jpg"
                        alt="Randil Lanka Tours"
                      />
                      <span className="quote">Over 1,000 Happy Travelers</span>
                    </div>
                    <div className="image-about-item relative about-wrap-right">
                      <img
                        src="/assets/images/about-us/sl-2.jpg"
                        alt="Randil Lanka Tours"
                      />
                    </div>
                    <div className="box-year center">
                      ...
                      <p>
                        Years of <br /> Exceptional Travel Experience
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-md-6 inner-content-about">
                  <div className="mb-30">
                    ...
                    <h2 className="title-heading mb-18">
                      Unforgettable{" "}
                      <span className="text-gray font-yes">Journeys</span> Await
                      You
                    </h2>
                    <p className="des">
                      Randil Lanka Tours is your gateway to exploring the
                      breathtaking landscapes, rich culture, and hidden gems of
                      Sri Lanka. Let us craft a unique and memorable travel
                  ...
                  <div className="row">
                    <div className="col-md-6">
                      <div className="icon-box-style6">
                        ...
                        <div className="content">
                          <h6 className="title-icon">
                            <a href="">Expert Travel Guides</a>
                          </h6>
                          <p className="des-icon">
                            Our local guides provide authentic insights and
                            personalized service to enhance your journey.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="col-md-6">
                      <div className="icon-box-style6">
                        <div className="icon relative">
                          <i className="icon-custom-itinerary" />
                        </div>
                        <div className="content">
                          <h6 className="title-icon">
                            <a href="">Customized Itineraries</a>
                          </h6>
                          <p className="des-icon">
                            Tailor-made tours to suit your travel preferences,
                            from cultural explorations to adventurous getaways.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex-three btn-wrap-about ">
                    <a href="/packages" className="btn-main">
                      <p className="btn-main-text">Go to Packages</p>
                      <p className="iconer">
                  ...
                  <div className="video-h4-widget relative overflow-hidden mb--14em">
                    <div className="video-wrap">
                      <a
                        ...
                        className="video-box flex-five z-index3 relative widget-videos"
                      >
                        <i className="icon-Polygon-4" />
                      </a>
                    </div>
                    <p className="font-yes text-white center text-video z-index3 relative">
                      Watch Video
                    </p>
                  </div>
                </div>
            ...
            <div className="tf-container">
              <div className="row">
                ...
                <div className="col-lg-12 relative top-this-week-slide">
                  <Swiper
                    {...swiperOptions}
                    className="swiper populer-activities overflow-hidden"
                  >
                        ...
                        <SwiperSlide>
                          <div className="tour-listing box-sd">
                            ...
                            >
                              ...
                              <img src={tour.image} alt={tour.title} style={{width:"310px", height:"230px"}}/>
                            </Link>
          ...
          <section className="mt--82 ">
            <div className="tf-container">
              <div className="callt-to-action flex-two z-index3 relative shimmer-box">
                <div className="callt-to-action-content flex-three">
                  <div className="image">
                    <img src="/assets/images/page/healthcare.svg" alt="Image" />
                  </div>
                  <div className="content">
                    <h2 className="title-call">
                      {" "}
                      Free Health & Safety Officer for Groups (10+ Pax)
                    </h2>
                    <p className="des" style={{ color: "white" }}>
                      Travel with peace of mind! We offer free health and safety
                      support for tour groups with over 10 pax
                      {/* served—including on-call medical help, first-aid
                      responders, and safety checks throughout your trip. */}
                    </p>
                  </div>
                </div>
                <img
                ...
                <div className="callt-to-action-button">
                  <Link href="/packages" className="get-call">
                    Start Your Journey
                  </Link>
                </div>
              </div>
            ...
            <div className="tf-container">
              <div className="row al-i-end mb-40">
                <div className="col-md-7">
                  <div>
                    <span className="sub-title-heading text-main fs-28-46 font-yes">
                      Discover Sri Lanka
                    </span>
                ...
                <div className="col-md-5">
                  <p>
                    Experience the beauty of Sri Lanka with expert guides,
                    customized itineraries, and seamless travel experiences. Let
                    us make your journey unforgettable.
                  </p>
                </div>
              </div>
              <div className="row">
                <div className="col-sm-6 col-lg-3">
                  <div className="tf-icon-box icon-box-style1 relative">
                    ...
                    <div className="content">
                      <h4 className="title-icon">Expert Local Guides</h4>
                      <p className="des-icon">
                        Our experienced guides provide deep insights into Sri
                        Lanka’s culture, history, and natural beauty.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-sm-6 col-lg-3">
                  <div className="tf-icon-box icon-box-style1 relative">
                    <div className="icon">
                      <i className="icon-customization" />
                    </div>
                    <div className="content">
                      <h4 className="title-icon">Tailored Itineraries</h4>
                      <p className="des-icon">
                        We design personalized tours to match your
						<br/> travel
                ...
                <div className="col-sm-6 col-lg-3">
                  <div className="tf-icon-box icon-box-style1 relative">
                    ...
                    <div className="content">
                      <h4 className="title-icon">Comfort & Luxury</h4>
                      <p className="des-icon">
                        Enjoy top-rated accommodations and premium travel
                ...
                <div className="col-sm-6 col-lg-3">
                  <div className="tf-icon-box icon-box-style1 relative">
                    ...
                    <div className="content">
                      <h4 className="title-icon">24/7 Support</h4>
                      <p className="des-icon">
                        Our team is available around the clock to assist with
                        your travel needs and ensure a smooth experience.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="row">
                <div className="col-sm-6 col-lg-3">
                  <div className="tf-counter center tf-countto">
                    ...
                    >
                      <CounterNumber count={5489} />
                    </div>
                    <span className="line" />
                    <p className="title-counter text-white">
                      Happy <br />
                      Traveller
                    </p>
                  </div>
