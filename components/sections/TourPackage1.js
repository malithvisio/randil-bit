						...
						<div className="col-lg-12">
							<div className="center m0-auto w-text-heading">
								<span className="sub-title-heading text-main mb-15 fadeInUp wow">Explore the
									world</span>
								<h2 className="title-heading mb-40 fadeInUp wow">Amazing Featured Tour <span className="text-gray font-yes">Package</span> the world</h2>
							</div>
							<div className="tab-tour-list">
								<ul className="nav justify-content-center tab-list mb-37" id="myTab" role="tablist">
									<li className="nav-item"  onClick={() => handleTab(1)}>
										<button className={isTab == 1 ? "nav-link active" : "nav-link"} id="new-york-tab" data-bs-toggle="tab" data-bs-target="#new-york-tab-pane" type="button" role="tab" aria-controls="new-york-tab-pane" aria-selected="true">New York</button>
									</li>
									<li className="nav-item"  onClick={() => handleTab(2)}>
										<button className={isTab == 2 ? "nav-link active" : "nav-link"} id="london-tab" data-bs-toggle="tab" data-bs-target="#london-tab-pane" type="button" role="tab" aria-controls="london-tab-pane" aria-selected="false">London</button>
									</li>
									<li className="nav-item"  onClick={() => handleTab(3)}>
										<button className={isTab == 3 ? "nav-link active" : "nav-link"} id="tokyo-tab" data-bs-toggle="tab" data-bs-target="#tokyo-tab-pane" type="button" role="tab" aria-controls="tokyo-tab-pane" aria-selected="false">Tokyo</button>
									</li>
									<li className="nav-item"  onClick={() => handleTab(4)}>
										<button className={isTab == 4 ? "nav-link active" : "nav-link"} id="los-angelas-tab" data-bs-toggle="tab" data-bs-target="#los-angelas-tab-pane" type="button" role="tab" aria-controls="los-angelas-tab-pane" aria-selected="false">Los
											Angelas</button>
									</li>
									<li className="nav-item"  onClick={() => handleTab(5)}>
										<button className={isTab == 5 ? "nav-link active" : "nav-link"} id="manila-tab" data-bs-toggle="tab" data-bs-target="#manila-tab-pane" type="button" role="tab" aria-controls="manila-tab-pane" aria-selected="false">Manila</button>
									</li>
								</ul>
								<div className="tab-content" id="myTabContent">
									<div className={isTab == 1 ? "tab-pane fade show active" : "tab-pane fade"} id="new-york-tab-pane" role="tabpanel" aria-labelledby="new-york-tab" tabIndex={0}>
										<div className="row">
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing wow fadeInUp animated " data-wow-delay="0.1s">
													...
													<div className="tour-listing-content">
														...
														<span className="map"><i className="icon-Vector4" />United States
															USA</span>
														<h3 className="title-tour-list"><Link href="/tour-single">Days
															and 6 nights
															From Moscow</Link>
														</h3>
											...
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing wow fadeInUp animated " data-wow-delay="0.2s">
													<Link href="/tour-single" className="tour-listing-image">
														<div className="badge-top flex-two">
															<span className="feature">Featured</span>
															<div className="badge-media flex-five">
											...
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing wow fadeInUp animated " data-wow-delay="0.3s">
													<Link href="/tour-single" className="tour-listing-image">
														<div className="badge-top flex-two">
															<span className="feature">Featured</span>
															<div className="badge-media flex-five">
											...
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing wow fadeInUp animated " data-wow-delay="0.4s">
													<Link href="/tour-single" className="tour-listing-image">
														<div className="badge-top flex-two">
															<span className="feature">Featured</span>
															<div className="badge-media flex-five">
									...
									<div className={isTab == 2 ? "tab-pane fade show active" : "tab-pane fade"} id="london-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabIndex={0}>
										<div className="row">
											<div className="col-sm-6 col-lg-3">
									...
									<div className={isTab == 3 ? "tab-pane fade show active" : "tab-pane fade"} id="tokyo-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex={0}>
										<div className="row">
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing">
													<Link href="/tour-single" className="tour-listing-image">
									...
									<div className={isTab == 4 ? "tab-pane fade show active" : "tab-pane fade"} id="los-angelas-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex={0}>
										<div className="row">
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing">
													<Link href="/tour-single" className="tour-listing-image">
									...
									<div className={isTab == 5 ? "tab-pane fade show active" : "tab-pane fade"} id="manila-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabIndex={0}>
										<div className="row">
											<div className="col-sm-6 col-lg-3">
												<div className="tour-listing">
													<Link href="/tour-single" className="tour-listing-image">
